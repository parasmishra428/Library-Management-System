...
<body style="background-color: #004528;">
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE admin SET first='$first', last='$last', username='$username', password='$password', email='$email', contact='$contact',pic='$img' WHERE username='".$_SESSION['login_user']."';";
